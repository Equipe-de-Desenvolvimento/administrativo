            ...
            foreach ($listarexame as $item) {
                ...
                $cabecalho = "<?xml version='1.0' encoding='iso-8859-1'?>
                            <NAJA>
                                ...
                                <NJ_LocalLaudo>/home/johnny/projetos/clinica/upload/laudo/" . $convenio . "/" . $item->paciente_id . "</NJ_LocalLaudo>
                ...
                $nome = "/home/johnny/projetos/clinica/upload/laudo/" . $convenio . "/" . $item->paciente_id . "/" . $item->paciente_id . ".xml";
                $xml = $cabecalho . $corpo . $rodape;
                $fp = fopen($nome, "w+");
                fwrite($fp, $xml . "\n");
                fclose($fp);

                $nome = "/home/johnny/projetos/clinica/upload/laudo/" . $convenio . "/" . $item->paciente_id . "/" . $item->paciente_id . ".rtf";
                $rtf = $texto;
                $fp = fopen($nome, "w+");
                fwrite($fp, $rtf . "\n");
                fclose($fp);
