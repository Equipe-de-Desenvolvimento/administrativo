...
class Notafiscal extends BaseController {
    ...
    function gerarnotafiscal($solicitacao_cliente_id) {
        ...
        $pathNfePhp = "/home/johnny/projetos/administrativo/application/libraries/nfephp";
        require_once ("$pathNfePhp/bootstrap.php");
...
//        use NFePHP\NFe\ToolsNFe;
        ...
        $nfeTools = new ToolsNFe("$pathNfePhp/config/config.json");
