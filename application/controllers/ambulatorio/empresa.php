...
//            $this->carregarView($data);
    ...
    function importarcertificado() {
        ...
        $verifica = $data['arquivo_pasta'] = directory_map("./upload/certificado/$empresa_id");
        $teste = false;
        ...
        if ($teste) {
            ...
            if ($extensao[1] == 'pfx') {
                $config['upload_path'] = "./upload/certificado/" . $empresa_id . "/";
        ...
        require_once ('./application/libraries/nfephp/arquivosNfe/geraCertsNFe.php');
    ...
    function carregarempresacertificado($empresa_id) {
        ...
        $data['arquivo_pasta'] = directory_map("./upload/certificado/$empresa_id");
        if ($data['arquivo_pasta'] != false) {
            sort($data['arquivo_pasta']);
        }
        $data['arquivos_deletados'] = directory_map("./upload/certificado/$empresa_id/excluidos");
