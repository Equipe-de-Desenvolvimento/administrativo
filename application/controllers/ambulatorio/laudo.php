...
//        $arquivo_pasta = directory_map( base_url() . "dicom/");
        ...
        $arquivo_pasta = directory_map("/home/ubuntu/projetos/clinica/cr/$agenda_exames_id/");
        $origem = "/home/ubuntu/projetos/clinica/cr/$agenda_exames_id";
...
//                  
//                        $nova = $valor;
//                        if (!is_dir("/home/ubuntu/projetos/clinica/upload/$exame_id")) {
//                            mkdir("/home/ubuntu/projetos/clinica/upload/$exame_id");
//                            $destino = "/home/ubuntu/projetos/clinica/upload/$exame_id/$nova";
//                            chmod($destino, 0777);
//                        }
//                        $destino = "/home/ubuntu/projetos/clinica/upload/$exame_id/$nova";
...
//        }        
        ...
        $this->load->helper('directory');
        $data['arquivo_pasta'] = directory_map("/home/ubuntu/projetos/clinica/upload/$exame_id/");
...
//        $nomearquivo = $convenio . "-" . $paciente . "-" . $datainicio . "-" . $datafim;
        $origem = "/home/ubuntu/projetos/clinica/upload/laudo";
...
//                $sl_cod_doc = $num_aleatorio . $data_cod . $horario_cod;
                    ...
                    $nome = "/home/ubuntu/projetos/clinica/upload/laudo/" . $convenio . "/" . $item->paciente_id . "/" . $sl_cod_doc . ".xml";
                    $xml = $cabecalho . $corpo . $fim_numguia . $rodape;
                    $fp = fopen($nome, "w+");
                    fwrite($fp, $xml . "\n");
                    fclose($fp);

                    $nomepdf = "/home/ubuntu/projetos/clinica/upload/laudo/" . $convenio . "/" . $item->paciente_id . "/" . $sl_cod_doc . ".pdf";
                    ...
                    $zip = new ZipArchive;
                    $this->load->helper('directory');
                    $arquivo_pasta = directory_map("/home/ubuntu/projetos/clinica/upload/laudo/$convenio/$item->paciente_id/");
                    $pasta = $item->paciente_id;
                    if ($arquivo_pasta != false) {
                        foreach ($arquivo_pasta as $value) {
                            $zip->open("/home/ubuntu/projetos/clinica/upload/laudo/$convenio/$pasta/$sl_cod_doc.zip", ZipArchive::CREATE);
                            $zip->addFile("/home/ubuntu/projetos/clinica/upload/laudo/$convenio/$pasta/$value", "$sl_cod_doc.xml");
                            $zip->addFile("/home/ubuntu/projetos/clinica/upload/laudo/$convenio/$pasta/$value", "$sl_cod_doc.pdf");
                            $zip->close();
                        }
                        $arquivoxml = "/home/ubuntu/projetos/clinica/upload/laudo/$convenio/$pasta/$sl_cod_doc.xml";
                        $arquivopdf = "/home/ubuntu/projetos/clinica/upload/laudo/$convenio/$pasta/$sl_cod_doc.pdf";
                        unlink($arquivoxml);
                        unlink($arquivopdf);
                    }
            ...
            foreach ($listarexame as $item) {
                ...
                $cabecalho = "<?xml version='1.0' encoding='iso-8859-1'?>
                            <NAJA>
                                ...
                                <NJ_LocalLaudo>/home/ubuntu/projetos/clinica/upload/laudo/" . $convenio . "</NJ_LocalLaudo>
                ...
                $nome = "/home/ubuntu/projetos/clinica/upload/laudo/" . $convenio . "/" . $item->paciente_id . ".xml";
                $xml = $cabecalho . $corpo . $rodape;
                $fp = fopen($nome, "w+");
                fwrite($fp, $xml . "\n");
                fclose($fp);

                $nome = "/home/ubuntu/projetos/clinica/upload/laudo/" . $convenio . "/" . $item->paciente_id . ".rtf";
                $rtf = $texto;
                $fp = fopen($nome, "w+");
                fwrite($fp, $rtf . "\n");
                fclose($fp);
...
//                    }
                    ...
                    if ($item->paciente_id !== $paciente_dif) {
                      ...
                      <SL_DATA_REALIZACAO>" . substr($item->data_realizacao, 0, 10) . "T" . substr($item->data_realizacao, 10, 18) . " </SL_DATA_REALIZACAO>
                       ...
                       <SL_TEXTO></SL_TEXTO>
                        ...
                        $nome = "/home/ubuntu/projetos/clinica/upload/laudo/" . $convenio . "/" . $sl_cod_doc . ".xml";
                        $xml = $cabecalho . $corpo . $fim_numguia . $rodape;
                        $fp = fopen($nome, "w+");
                        fwrite($fp, $xml . "\n");
                        fclose($fp);

                        $nomepdf = "/home/ubuntu/projetos/clinica/upload/laudo/" . $convenio . "/" . $sl_cod_doc . ".pdf";
                        $cabecalhopdf = "<table><tr><td><img align = 'left'  width='1000px' height='300px' src='img/cabecalho.jpg'></td></tr><tr><td>Nome:" . $item->paciente . " <br>Emiss&atilde;o: </td></tr></table>";
                        $rodapepdf = "<img align = 'left'  width='1000px' height='300px' src='img/rodape.jpg'>";
                        salvapdf($texto, $nomepdf, $cabecalhopdf, $rodapepdf);
                        ...
                        $zip = new ZipArchive;
                        $this->load->helper('directory');
                        $arquivo_pasta = directory_map("/home/ubuntu/projetos/clinica/upload/laudo/$convenio/");
                        $pasta = $item->paciente_id;
                        if ($arquivo_pasta != false) {
                            foreach ($arquivo_pasta as $value) {
                                $zip->open("/home/ubuntu/projetos/clinica/upload/laudo/$convenio/$sl_cod_doc.zip", ZipArchive::CREATE);
                                $zip->addFile("/home/ubuntu/projetos/clinica/upload/laudo/$convenio/$value", "$sl_cod_doc.xml");
                                $zip->addFile("/home/ubuntu/projetos/clinica/upload/laudo/$convenio/$value", "$sl_cod_doc.pdf");
                                $zip->close();
                            }
                            $arquivoxml = "/home/ubuntu/projetos/clinica/upload/laudo/$convenio/$sl_cod_doc.xml";
                            $arquivopdf = "/home/ubuntu/projetos/clinica/upload/laudo/$convenio/$sl_cod_doc.pdf";
                            unlink($arquivoxml);
                            unlink($arquivopdf);
                        }
                ...
                $cabecalho = "<?xml version='1.0' encoding='iso-8859-1'?>
                            <NAJA>
                                ...
                                <NJ_LocalLaudo>/home/ubuntu/projetos/clinica/upload/laudo" . $convenio . "/" . $listarexame[0]->paciente_id . "</NJ_LocalLaudo>
                                <NJ_FormatoLaudo>RTF</NJ_FormatoLaudo>
                ...
                $nome = "/home/ubuntu/projetos/clinica/upload/laudo/" . $convenio . "/" . $listarexame[0]->paciente_id . "/" . $listarexame[0]->paciente_id . ".xml";
                $xml = $cabecalho . $corpo . $rodape;
                $fp = fopen($nome, "w+");
                fwrite($fp, $xml . "\n");
                fclose($fp);

                $nome = "/home/ubuntu/projetos/clinica/upload/laudo/" . $convenio . "/" . $listarexame[0]->paciente_id . "/" . $listarexame[0]->paciente_id . ".rtf";
                $rtf = $texto;
                $fp = fopen($nome, "w+");
                fwrite($fp, $rtf . "\n");
                fclose($fp);
