...
//        $this->gastosdesala($exame_id);
    ...
    function anexarimagem($exame_id, $sala_id) {
        ...
        $data['arquivos_deletados'] = directory_map("/home/ubuntu/projetos/clinica/uploadopm/$exame_id/");
...
//        die;
        ...
        $config['upload_path'] = "/home/ubuntu/projetos/clinica/upload/" . $exame_id . "/";
    ...
    function moverimagens($exame_id, $sala_id) {
        ...
        if ($sala_id == 1) {
            ...
            $arquivo_pasta = directory_map("/home/ubuntu/projetos/clinica/upload/ultrasom1/");
            //$origem = "/home/hamilton/teste";
            $origem = "/home/ubuntu/projetos/clinica/upload/ultrasom1";
        ...
        if ($sala_id == 2) {
            ...
            $arquivo_pasta = directory_map("/home/ubuntu/projetos/clinica/upload/ultrasom2/");
            $origem = "/home/ubuntu/projetos/clinica/upload/ultrasom2";
            foreach ($arquivo_pasta as $value) {
                $nova = substr($value, 11, 6);
                if (!is_dir("/home/ubuntu/projetos/clinica/upload/$exame_id")) {
                    mkdir("/home/ubuntu/projetos/clinica/upload/$exame_id");
        ...
        if ($sala_id == 9) {
            ...
            $arquivo_pasta = directory_map("/home/ubuntu/projetos/clinica/upload/ultrasom3/");
            $origem = "/home/ubuntu/projetos/clinica/upload/ultrasom3";
            foreach ($arquivo_pasta as $value) {
...
//            $this->carregarView($data);
    ...
    function gerarcr($agenda_exames_id) {
        ...
        if (!is_dir("/home/ubuntu/projetos/clinica/cr/")) {
            mkdir("/home/ubuntu/projetos/clinica/cr/");
        }
        $nome = "/home/ubuntu/projetos/clinica/cr/" . $agenda_exames_id . ".txt";
        $fp = fopen($nome, "w+");
        fwrite($fp, $titulo . "\n");
        fwrite($fp, $comando . "\n");
        fwrite($fp, $id . "\n");
...
//        die;
        ...
        $origem = "/home/ubuntu/projetos/clinica/upload/cr/" . $convenio;

        if (!is_dir("/home/ubuntu/projetos/clinica/upload/cr/" . $convenio)) {
            mkdir("/home/ubuntu/projetos/clinica/upload/cr/" . $convenio);
            chmod($origem, 0777);
        }
        if ($_POST['apagar'] == 1) {
            delete_files($origem);
...
<ans:mensagemTISS xmlns='http://www.w3.org/2001/XMLSchema' xmlns:ans='http://www.ans.gov.br/padroes/tiss/schemas'>
   ...
   <ans:epilogo>
      <ans:hash>035753bf836c231bedbc68a08daf4668</ans:hash>
                                ...
                                $nome = "/home/ubuntu/projetos/clinica/upload/cr/" . $convenio . "/" . $zero . $b . "_" . $nomearquivo . ".xml";
...
<ans:hash>e2eadfe09fd6750a184902545aa41771</ans:hash>
                        ...
                        $nome = "/home/ubuntu/projetos/clinica/upload/cr/" . $convenio . "/" . $zero . $b . "_" . $nomearquivoconsulta . ".xml";
                        $xml = $cabecalho . $corpo . $rodape;
                        $fp = fopen($nome, "w+");
                        fwrite($fp, $xml . "\n");
                        fclose($fp);
...
";
        ...
        $zip = new ZipArchive;
        $this->load->helper('directory');
        $arquivo_pasta = directory_map("/home/ubuntu/projetos/clinica/upload/cr/$convenio/");
        if ($arquivo_pasta != false) {
            foreach ($arquivo_pasta as $value) {
                $deletar[] = "/home/ubuntu/projetos/clinica/upload/cr/$convenio/$value";
            }
            foreach ($arquivo_pasta as $value) {
                $zip->open("/home/ubuntu/projetos/clinica/upload/cr/$convenio/$value.zip", ZipArchive::CREATE);
                $zip->addFile("/home/ubuntu/projetos/clinica/upload/cr/$convenio/$value", "$value");
//           $deletarxml = "/home/ubuntu/projetos/clinica/upload/cr/$convenio/$value";
//           unlink($deletarxml);
            }
            $zip->close();
