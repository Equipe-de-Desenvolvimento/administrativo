...
<div id="tabs">
  ...
  <div id="tabs-1">
    ...
    <div id="direita">
        ...
        <h3>Portanto é recomendável que seja usado o S.O. mais atualizado possível. Testes foram feitos usando DEBIAN (wheezy e Jessie) e sisprod 14.04 LTS em ambos os casos a API funcionou perfeitamente, e usando apenas os pacotes da distribuição sem a necessidade de baixar pacotes de outras fontes ou compila-los de fonte mais atualizada.</h3>
        <p></p>
