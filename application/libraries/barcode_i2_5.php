...
{    
    ...
    function BarcodeI25($code='')
    {
        ...
        $this->ebg          = 3;
        $this->altb         = 50;
        $this->ipp          = "/home/johnny/projetos/administrativo/img/boleto/ponto_preto.gif";
        $this->ipb          = "/home/johnny/projetos/administrativo/img/boleto/ponto_branco.gif";
        $this->mixed_code   = "";
        $this->bc_string    = "";
        $this->tamanhoTotal = 0;
...
//				header("Content-type: image/png");
			...
			if($this->tipoRetorno == 0) {
				...
				// -> mas sinceramente � besteira colocar outros tipos. png j� da e sobra! 
                                ...
                                imagepng($barra_imagem, "/home/johnny/projetos/administrativo/upload/codigoboleto/$this->codigo");
