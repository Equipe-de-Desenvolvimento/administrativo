...
//Guarda inicial
?><img src=<?= base_url(); ?>img/boleto/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?= base_url(); ?>img/boleto/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?= base_url(); ?>img/boleto/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?= base_url(); ?>img/boleto/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
<?php
$texto = $valor ;
if((strlen($texto) % 2) <> 0){
