<div class="content"> <!-- Inicio da DIV content -->
    <div id="accordion">
        <h3 class="singular"><a href="#">Cadastro de Inventario</a></h3>

        <div>
            <form name="form_inventario" id="form_inventario" action="<?= base_url() ?>estoque/inventario/gravar" method="post">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        jQuery('#form_inventario').validate( {
            rules: {
                txtproduto: {
                    required: true
                },
