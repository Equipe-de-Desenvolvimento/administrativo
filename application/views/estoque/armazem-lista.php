        ...
        <div>
            <table>
                <thead>
                    <tr>
                        <th colspan="5" class="tabela_title">
                            <form method="get" action="<?= base_url() ?>estoque/armazem/pesquisar">
                ...
                <?php
                    ...
                    $consulta = $this->armazem->listar($_GET);
                    ...
                    <?php
                     ...
                     ?>
                            <tr>
                                ...
                                <td class="<?php echo $estilo_linha; ?>" width="70px;">                                  
                                    <a onclick="javascript: return confirm('Deseja realmente exlcuir esse Armazem?');" href="<?= base_url() ?>estoque/armazem/excluir/<?= $item->estoque_armazem_id ?>">Excluir</a>
                            </td>
                        </tr>
