...
//                                                            opcoesCabecalho += '<td></td>';
                                                    ...
                                                    opcoesCabecalho += '<td colspan="2" ><input type="checkbox" name="selTodos" id="selTodos"/><span style="font-weight: bold; margin-left:3pt;">Ativar Todos</span></tr>';
                                                    opcoesCabecalho += '<tr><td colspan="7"  style="border-bottom: 1px solid black;"></td></tr>';
                                                    opcoesCabecalho += '<tr> <td>&nbsp;</td> <td><span class="tbTitulo">Produto</span></td> <td><span class="tbTitulo">Vlr Compra</span></td> <td><span class="tbTitulo">Percentual</span></td> <td><span class="tbTitulo">Desconto</span></td> <td><span class="tbTitulo">Vlr Venda</span></td> <td><span class="tbTitulo">Ativo</span></td> </tr>';
                                                    var options = '';
