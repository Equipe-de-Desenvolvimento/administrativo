<head>
    <style>
        .linha_abaixo{ border-bottom: 1px solid black; }
        .tabela_principal{ margin: 0 0 -30pt 0;  width: 100%;width: 100%; }
        .cabecalho_principal{
            font-size: 9pt;
            margin-bottom: -15pt;
            margin-top: -15pt;
            ...
            <tr>
                ...
                <td>
                    <div style="float: left;">
                        <table class="tabela_principal" cellspacing="5">

                            <!-- PRIMEIRO CABECALHO -->
                            <tr colspan="2">
                                <td>
                                    <img src="img/logo peq.jpg" alt="" width="200" height="100" border="1" style="margin-bottom: -10pt;">
                                </td>
                                <td>
                                    <table class="cabecalho_principal" cellpadding="5">
                                        <tr>
...
<!--                                            <td colspan="2"><span class="negrito">Fax: </span> <?= @$empresa[0]->fax; ?></td>
                            ...
                            <tr>
                                <td colspan="3">
                                    <table class="cabecalho_secundario" cellpadding="5">
                                        <tr>
