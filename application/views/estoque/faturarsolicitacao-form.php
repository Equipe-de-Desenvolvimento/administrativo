            ...
            <form name="form_faturar" id="form_faturar" action="<?= base_url() ?>estoque/solicitacao/gravarfaturamento" method="post">
                <fieldset>
                    ...
                    <dl class="dl_desconto_lista">
                        ...
                        <br/>
                        <dt>
                            <label><label >Valor1 / Descricao de pagamento1 / Forma de pagamento1 / Ajuste1(%) /  Valor Ajustado1 / Parcelas1</label>
                        </dt>
                        <dd>
                            ...
                            <select  name="forma_pagamento_1" id="forma_pagamento_1" class="size1" >
                                <option value="">Selecione</option>
                        ...
                        <br/>
                        <dt>
                            <label>Valor2/ Descricao de pagamento2 / Forma de pagamento2 / Ajuste2(%) / Valor Ajustado2 / Parcelas2</label>
                        </dt>
                        <dd>
                            ...
                            <select  name="forma_pagamento_2" id="forma_pagamento_2" class="size1" >
                                <option value="">Selecione</option>
                                <? foreach ($forma_pagamento as $item) : ?>
                                    <option value="<?= $item->forma_pagamento_id; ?>" ><?= $item->nome; ?></option>
                                <? endforeach; ?>
                        ...
                        <br/>
                        <dt>
                            <label>Valor3/ Descricao de pagamento3 / Forma de pagamento3 / Ajuste3(%) / Valor Ajustado3 / Parcelas3</label>
                        </dt>
                        <dd>
                            ...
                            <select  name="forma_pagamento_3" id="forma_pagamento_3" class="size1" >
                                <option value="">Selecione</option>
                                <? foreach ($forma_pagamento as $item) : ?>
                                    <option value="<?= $item->forma_pagamento_id; ?>" ><?= $item->nome; ?></option>
                                <? endforeach; ?>
                        ...
                        <br/>
                        <dt>
                            <label>Valor4/ Descricao de pagamento4 / Forma de pagamento4 / Ajuste4(%) / Valor Ajustado4 / Parcelas4</label>
                        </dt>
                        <dd>                           
                            ...
                            <select  name="forma_pagamento_4" id="forma_pagamento_4" class="size1" >
                                <option value="">Selecione</option>
                                <? foreach ($forma_pagamento as $item) : ?>
                                    <option value="<?= $item->forma_pagamento_id; ?>" ><?= $item->nome; ?></option>
                                <? endforeach; ?>
