<head>
    <style>
        ...
        .tabela_principal{ margin: 0 0 -30pt 0; width: 100%; }
        .cabecalho_principal{
            font-size: 9pt;
            margin-bottom: -20pt;
            margin-top: -15pt;
        ...
        .dados_cabecalho{ font-size: 10pt; }
        .corpo{
            margin-top: 5pt;
            min-height: 100pt;
        }
        .tabela_fim{ font-size: 9pt; }
                ...
                <td>
                    <div style="float: left;" >
                        <table class="tabela_principal">
                            ...
                            <tr>
                                <td>
                                    <img src="img/logo peq.jpg" alt="" width="200" height="70" border="1">
                                </td>
                                <td>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                </td>
