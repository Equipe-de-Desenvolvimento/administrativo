                ...
                if ($total > 0) {
                    ...
                    <tbody>
                        ...
                        if ($limit != "todos") {
                            ...
                            $lista = $this->contasreceber->listar($_GET)->orderby('data')->get()->result();
                        }
                            ...
                            Saldo Total: <?= number_format($saldo[0]->sum, 2, ",", ".") ?>
                             <div style="display: inline">
                                ...
                                <select style="width: 50px">
                                    <option onclick="javascript:window.location.href = ('<?= base_url() ?>cadastros/contasreceber/pesquisar/25');" <? if ($limit == 25) {
                                echo "selected";
                            } ?>> 25 </option>
                                    <option onclick="javascript:window.location.href = ('<?= base_url() ?>cadastros/contasreceber/pesquisar/50');" <? if ($limit == 50) {
                                echo "selected";
                            } ?>> 50 </option>
                                    <option onclick="javascript:window.location.href = ('<?= base_url() ?>cadastros/contasreceber/pesquisar/100');" <? if ($limit == 100) {
                                echo "selected";
                            } ?>> 100 </option>
                                    <option onclick="javascript:window.location.href = ('<?= base_url() ?>cadastros/contasreceber/pesquisar/todos');" <? if ($limit == "todos") {
                                echo "selected";
                            } ?>> Todos </option>
                                </select>
                            </div>
