    ...
    <div class="browser-landing" id="main">
      <div class="compact marquee-stacked" id="marquee">
        <div class="marquee-copy">
          <h1>
            <a class="c1" href="http://dvcs.w3.org/hg/speech-api/raw-file/tip/speechapi.html">Tela de gravação de laudo</a>      </h1>
        </div>
      </div>
      <div class="compact marquee">
        ...
        <div id="div_start">
          <button id="start_button" onclick="startButton(event)">Gravar</button>
        </div>
        <div id="results">
...
if (!('webkitSpeechRecognition' in window)) {
  ...
  recognition.onstart = function() {
    ...
    start_img.src = '/home/johnny/projetos/clinica/img/mic.gif';
  };
